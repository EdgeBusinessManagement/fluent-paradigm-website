...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const subject = `New message from ${name || "Fluent Paradigm website"}`
    const body =
      `Name: ${name}\n` +
      `Email: ${email}\n\n` +
      `Message:\n${message}`
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16 animate-fade-in-up">
              ...
              <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                Whether you&apos;re exploring a partnership, an investment
                opportunity, a project, or a career with us, we&apos;d love to
                hear from you. Every great collaboration — and every great
                company — begins with a conversation.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              ...
              <div className="bg-card border border-border rounded-lg p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    type="submit"
                    className="w-full copper-gradient text-[#0A0E14] font-bold hover:opacity-90"
                  >
                    Send Message
                  </Button>
                </form>
            ...
            <div className="bg-card border border-primary rounded-lg p-12 text-center">
              ...
              <h2 className="text-3xl font-bold mb-4 copper-gradient-text">
                Investor Relations
              </h2>
              <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-6 leading-relaxed">
                We believe that lasting growth happens when technology and
                humanity move in the same direction. Fluent Paradigm partners
                with investors who share our people-first values — those who see
                integrity, collaboration, and innovation as inseparable.
              </p>
              <p className="text-gray-400 mb-6">
                If you&apos;re interested in supporting the growth of Fluent
                Paradigm Technologies or exploring strategic collaboration,
